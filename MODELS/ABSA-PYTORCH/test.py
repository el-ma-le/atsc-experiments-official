...
def main():
    ...
    dataset_files = {
        'restaurant': {
            'test': '../../DATA/SEMEVAL-14-REST/test.xml.seg'
        },
        'laptop': {
            'test': '../../DATA/SEMEVAL-14-LAP/test.xml.seg'
        },
        'mams': {
            'test': '../../DATA/MAMS/test.xml.seg'
        },
        'arts-rest':{
            'test': '../../DATA/ARTS-REST/test.xml.seg'
        },
        'arts-lap':{
            'test': '../../DATA/ARTS-LAP/test.xml.seg'
        }
    }
    ...
    tokenizer_files = {
        'restaurant': {
            'train': '../../DATA/SEMEVAL-14-REST/train_'+str(opt.train_seed)+'.xml.seg',
            'val': '../../DATA/SEMEVAL-14-REST/val_'+str(opt.train_seed)+'.xml.seg',
            },
        'laptop': {
            'train': '../../DATA/SEMEVAL-14-LAP/train_'+str(opt.train_seed)+'.xml.seg',
            'val': '../../DATA/SEMEVAL-14-LAP/val_'+str(opt.train_seed)+'.xml.seg',
        },
        'mams': {
            'train': '../../DATA/MAMS/train.xml.seg',
            'val': '../../DATA/MAMS/val.xml.seg',
        },
        'arts-rest':{
            'train': '../../DATA/SEMEVAL-14-REST/train_'+str(opt.train_seed)+'.xml.seg',
            'val': '../../DATA/SEMEVAL-14-REST/val_'+str(opt.train_seed)+'.xml.seg',
