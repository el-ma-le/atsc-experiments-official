...
def build_tokenizer(fnames, max_seq_len, dat_fname):
    if os.path.exists("./tokenizers_embs/"+dat_fname):
        print('loading tokenizer:', dat_fname)
        tokenizer = pickle.load(open("./tokenizers_embs/"+dat_fname, 'rb'))
    else:
        text = ''
        for fname in fnames:
        ...
        pickle.dump(tokenizer, open("./tokenizers_embs/"+dat_fname, 'wb'))
    return tokenizer
...
def build_embedding_matrix(word2idx, embed_dim, dat_fname):
    if os.path.exists("./tokenizers_embs/"+dat_fname):
        ...
        embedding_matrix = pickle.load(open("./tokenizers_embs/"+dat_fname, 'rb'))
    else:
        print('loading word vectors...')
        embedding_matrix = np.zeros((len(word2idx) + 2, embed_dim))  # idx 0 and len(word2idx)+1 are all-zeros
        fname = './glove.twitter.27B/glove.twitter.27B.' + str(embed_dim) + 'd.txt' \
            if embed_dim != 300 else '/home/ubuntu/mylrz/atsc-experiments/DATA/glove.42B.300d.txt'
        ...
        pickle.dump(embedding_matrix, open("./tokenizers_embs/"+dat_fname, 'wb'))
...
class ABSADataset_arts(Dataset):
    def __init__(self, fname, tokenizer):
        fin = open(fname, 'r', encoding='utf-8', newline='\n', errors='ignore')
        lines = fin.readlines()
        fin.close()
