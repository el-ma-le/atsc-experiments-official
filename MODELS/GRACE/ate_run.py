...
def dataloader_val(args, tokenizer, file_path, labels, set_type="val"):
    ...
    print("Loaded eval file: {}".format(file_path))
...
def main():
    ...
    print("Labels are =  :", "["+", ".join(label_list)+"]")
    ...
    if args.do_train:
        ...
        for epoch in range(args.num_train_epochs):
            ...
            _, _, val_as_f1_micro = eval_epoch(model, eval_dataloader, label_list, device)
            #mlflow.log_metric("val_as_f1_micro", val_as_f1_micro, epoch)
        ...
        _,_, test_as_f1_micro = eval_epoch(model, test_dataloader, label_list, device)
        #mlflow.log_metric("as_f1_micro", test_as_f1_micro)
