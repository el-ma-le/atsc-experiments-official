...
def parse_args():
    ...
    parser.add_argument("--splits_available", default=1, help="for semeval data train/val splits are available" )
...
def main():
    ...
    # input files
    if args.splits_available == 1:
        train_file = args.data_dir + "/train_1.json"
        test_file = args.data_dir + "/val_1.json"
    else:
        train_file = args.data_dir + "/train.json"
        test_file = args.data_dir + "/val.json"
